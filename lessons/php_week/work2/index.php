...
<body  <?php if(isset($_SESSION['phpHIT'])) echo"onload=clk('t2');stateenable('".$State."');"?>>
			...
			<div class="rightcon">
				<table cellspacing="6" cellpadding="6">
					...
					<tr>
					  ...
					  <td>
					  <select id="state" value="" name="state"></select>
					  <span>*<?if(isset($_SESSION["stateErr"])) echo $_SESSION["stateErr"]; ?>
					  </td>
					</tr>
